...
export default function HomePage(props){
    return(
      ...
      <h1>Welcome to NutriFit-Health!</h1><br />
        ...
        <p>This is a place where people can come together and share their personal nutrition and fitness knowledge with others so we can all stay healthy! Whether you are trying to start</p>
      </div>
)}
